...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 pb-10">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg shadow-itd-navy/10 border border-itd-navy/10 p-8 text-center">
        <EncabezadoInstitucional />

        <h2 className="font-display text-xl font-semibold text-itd-navy mb-6">
